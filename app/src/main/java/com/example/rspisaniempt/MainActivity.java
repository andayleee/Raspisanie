...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new MyLayout2Model("Четверг","Неженская","Инструментальные средства разработки программного обеспечения","","Технология разработки программного обеспечения","","Иностранный язык","","Технология разработки и защиты баз данных","","",""));
        list.add(new MyLayout2Model("Пятница","Нахимовский","","","Системное программирование","","Разработка программных модулей","","Технология разработки программного обеспечения","Инструментальные средства разработки программного обеспечения","Разработка мобильных приложений",""));
